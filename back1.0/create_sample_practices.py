...
from books.models import Chapter, Practice, PracticeChoiceOption, PracticeFillBlank, TestCase

def create_sample_practices():
    """创建示例练习题数据"""
    ...
    for i, chapter in enumerate(chapters[:5]):
        try:
            ...
            if hasattr(chapter, 'practice') and chapter.practice:
                print(f"章节 '{chapter.title}' 已有练习题，跳过")
                continue
