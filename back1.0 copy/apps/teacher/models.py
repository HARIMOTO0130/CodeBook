...
class Class(models.Model):
    ...
    book = models.ForeignKey(Book, on_delete=models.CASCADE, related_name='classes', verbose_name='关联教材', db_column='book_id')
...
class Student(models.Model):
    ...
    class_obj = models.ForeignKey(Class, on_delete=models.CASCADE, related_name='students', verbose_name='所属班级', db_column='class_id')
...
class TeachingResource(models.Model):
    ...
    id = models.AutoField(primary_key=True, db_column='resource_id')
    chapter = models.ForeignKey(Chapter, on_delete=models.CASCADE, related_name='teaching_resources', verbose_name='所属章节', db_column='chapter_id')
