...
-- ----------------------------
INSERT INTO books_jupytercell VALUES ('1', 'markdown', '## 1.1 计算机系统概述\n\n计算机系统由硬件系统和软件系统两大部分组成。硬件系统是计算机的物理组成部分，包括中央处理器(CPU)、内存、存储设备、输入设备和输出设备等。软件系统则是运行在硬件之上的程序和数据，包括系统软件和应用软件。\n\n对于非计算机专业学生来说，了解计算机的基本组成和工作原理有助于我们更好地使用计算机。计算机的基本工作原理是存储程序和程序控制，即程序和数据存储在计算机的存储器中，由CPU依次取出并执行指令，完成预定的任务。\n\n随着计算机技术的发展，计算机的性能不断提升，应用领域也不断扩大。从最初的科学计算，到现在的人工智能、大数据分析等，计算机已经渗透到我们生活和工作的方方面面。', null, '{}', '0', '2026-01-05 09:01:21.770114', '2026-01-05 09:01:21.770114', 1);
INSERT INTO books_jupytercell VALUES ('2', 'markdown', '## 1.2 计算机中的数制与编码\n\n计算机内部采用二进制进行数据存储和处理。二进制只有0和1两个数字，运算规则简单，便于用电子元件实现。除了二进制，计算机中还常用到十进制、八进制和十六进制等数制，它们之间可以相互转换。\n\n在计算机中，各种信息（如文字、图像、声音等）都需要转换为二进制形式进行存储和处理。文字的编码是指用二进制数表示文字的规则，常见的编码标准有ASCII码、GB2312、UTF-8等。了解这些编码标准有助于我们正确地处理和显示各种文字信息。\n\n对于非计算机专业学生来说，掌握基本的数制转换方法和了解常见的编码标准是很有必要的，这有助于我们更好地理解计算机是如何处理信息的。', null, '{}', '1', '2026-01-05 09:01:21.777961', '2026-01-05 09:01:21.777961', 1);
INSERT INTO books_jupytercell VALUES ('3', 'code', '# 计算机存储单位换算示例\ndef storage_conversion(bytes_value):\n    units = [\'B\', \'KB\', \'MB\', \'GB\', \'TB\']\n    index = 0\n    value = float(bytes_value)\n    while value >= 1024 and index < len(units) - 1:\n        value /= 1024\n        index += 1\n    return f\"{value:.2f} {units[index]}\"\n\n# 测试函数\nprint(storage_conversion(1024))  # 1 KB\nprint(storage_conversion(1048576))  # 1 MB', null, '{}', '2', '2026-01-05 09:01:21.785979', '2026-01-05 09:01:21.785979', 1);
INSERT INTO books_jupytercell VALUES ('4', 'markdown', '## 1.1 数据分析概述\n\n数据分析是指用适当的统计分析方法对收集来的数据进行分析，提取有用信息并形成结论的过程。随着大数据时代的到来，数据分析在各个领域的重要性日益凸显。对于非计算机专业学生来说，掌握基本的数据分析技能可以帮助我们更好地理解和利用数据。\n\n数据分析的基本流程包括数据收集、数据清洗、数据转换、数据分析和数据可视化等步骤。在数据分析过程中，我们需要选择合适的分析方法和工具，根据数据的类型和分析的目的来确定具体的分析策略。', null, '{}', '0', '2026-01-05 09:01:21.771706', '2026-01-05 09:01:21.771706', 1);
...
INSERT INTO books_jupytercell VALUES ('6', 'code', '# 使用Pandas进行基本数据操作\nimport pandas as pd\ndef basic_data_operations(df):\n    print(\'数据基本信息:\')\n    print(df.info())\n    print(\'\n数据前5行:\')\n    print(df.head())\n    print(\'\n数据统计摘要:\')\n    print(df.describe())', null, '{}', '2', '2026-01-05 09:01:21.785979', '2026-01-05 09:01:21.785979', 2);
INSERT INTO books_jupytercell VALUES ('7', 'code', '# 数据清洗示例\nimport pandas as pd\ndef handle_missing_values(df):\n    print(\'缺失值统计:\')\n    print(df.isnull().sum())\n    # 填充数值型缺失值\n    numeric_cols = df.select_dtypes(include=[\'float64\', \'int64\']).columns\n    df[numeric_cols] = df[numeric_cols].fillna(df[numeric_cols].mean())\n    return df', null, '{}', '3', '2026-01-05 09:01:21.790666', '2026-01-05 09:01:21.790666', 2);
INSERT INTO books_jupytercell VALUES ('8', 'markdown', '## 1.1 人工智能的定义与发展历程\n\n人工智能（Artificial Intelligence，简称AI）是指由人制造出来的系统所表现出来的智能。人工智能的目标是让机器能够模拟人类的智能行为，如感知、推理、学习、决策等。对于非计算机专业学生来说，了解人工智能的基本概念和发展历程有助于我们更好地理解这一快速发展的技术领域。\n\n人工智能的发展大致可以分为三个阶段：第一阶段是人工智能的孕育期（1940s-1950s），这一时期主要是理论和技术的准备；第二阶段是人工智能的形成期（1950s-1960s），人工智能作为一个学科正式诞生；第三阶段是人工智能的发展期（1970s至今），人工智能经历了多次高潮和低谷，不断取得新的突破。', null, '{}', '0', '2026-01-05 09:01:21.773265', '2026-01-05 09:01:21.773265', 2);
INSERT INTO books_jupytercell VALUES ('9', 'markdown', '## 1.2 人工智能的主要领域与应用\n\n人工智能的应用领域非常广泛，涵盖了计算机视觉、自然语言处理、语音识别、专家系统、智能机器人等多个方面。计算机视觉是让计算机能够理解和解释图像或视频的技术，应用于人脸识别、物体检测、图像分割等任务；自然语言处理是让计算机能够理解和生成人类语言的技术，应用于机器翻译、情感分析、文本摘要等任务。', null, '{}', '1', '2026-01-05 09:01:21.779509', '2026-01-05 09:01:21.779509', 3);
INSERT INTO books_jupytercell VALUES ('10', 'code', '# 简单的智能对话机器人示例\ndef simple_chatbot():\n    responses = {\n        \'你好\': \'你好！很高兴见到你！\',\n        \'你是谁\': \'我是一个简单的对话机器人。\',\n        \'什么是人工智能\': \'人工智能是指由人制造出来的系统所表现出来的智能。\'\n    }\n    return responses', null, '{}', '2', '2026-01-05 09:01:21.787563', '2026-01-05 09:01:21.787563', 3);
INSERT INTO books_jupytercell VALUES ('11', 'code', '# 文本分类简单示例\ndef simple_text_classifier(text):\n    positive_words = [\'好\', \'棒\', \'优秀\', \'喜欢\']\n    negative_words = [\'差\', \'糟糕\', \'失望\', \'不满意\']\n    positive_count = sum(1 for word in positive_words if word in text)\n    negative_count = sum(1 for word in negative_words if word in text)\n    if positive_count > negative_count:\n        return \'正面评价\'\n    elif negative_count > positive_count:\n        return \'负面评价\'\n    else:\n        return \'中性评价\'', null, '{}', '3', '2026-01-05 09:01:21.792214', '2026-01-05 09:01:21.792214', 3);
INSERT INTO books_jupytercell VALUES ('12', 'markdown', '## 2.1 操作系统概述\n\n操作系统是管理计算机硬件与软件资源的系统软件，为用户提供了一个操作计算机的界面。常见的操作系统有Windows、macOS和Linux等。对于非计算机专业学生来说，熟悉操作系统的基本操作是使用计算机的前提。\n\n操作系统的主要功能包括进程管理、内存管理、文件管理和设备管理等。进程管理负责调度和控制程序的执行；内存管理负责分配和回收内存资源；文件管理负责组织和存取文件；设备管理负责管理和控制各种硬件设备。了解这些功能有助于我们更好地理解和使用操作系统。', null, '{}', '0', '2026-01-05 09:01:21.773265', '2026-01-05 09:01:21.773265', 3);
INSERT INTO books_jupytercell VALUES ('13', 'markdown', '## 2.2 文件与文件夹管理\n\n文件是存储在计算机中的一组相关信息的集合，通常具有特定的扩展名来标识文件类型。文件夹则是用于组织和管理文件的容器，可以嵌套创建子文件夹。合理地组织文件和文件夹结构有助于提高工作效率。\n\n在Windows操作系统中，文件系统采用树形结构，以驱动器盘符为根目录，向下延伸出多个层次的文件夹和文件。我们可以通过资源管理器来浏览、创建、移动、复制和删除文件和文件夹。学会这些基本操作对于日常的文件管理非常重要。', null, '{}', '1', '2026-01-05 09:01:21.779509', '2026-01-05 09:01:21.779509', 4);
INSERT INTO books_jupytercell VALUES ('14', 'code', '# 文件大小统计示例\nimport os\ndef get_directory_size(directory):\n    total_size = 0\n    for path, dirs, files in os.walk(directory):\n        for file in files:\n            try:\n                filepath = os.path.join(path, file)\n                total_size += os.path.getsize(filepath)\n            except OSError:\n                continue\n    return total_size', null, '{}', '2', '2026-01-05 09:01:21.787563', '2026-01-05 09:01:21.787563', 4);
INSERT INTO books_jupytercell VALUES ('15', 'code', '# 简单的文件重命名工具\nimport os\ndef batch_rename(directory, prefix):\n    count = 1\n    for filename in os.listdir(directory):\n        if os.path.isfile(os.path.join(directory, filename)):\n            file_ext = os.path.splitext(filename)[1]\n            new_name = f\"{prefix}_{count:03d}{file_ext}\"\n            os.rename(os.path.join(directory, filename), os.path.join(directory, new_name))\n            count += 1\n    return count - 1', null, '{}', '3', '2026-01-05 09:01:21.792214', '2026-01-05 09:01:21.792214', 4);
INSERT INTO books_jupytercell VALUES ('16', 'markdown', '## 2.1 描述性统计分析\n\n描述性统计分析是数据分析的基础，它通过计算各种统计量来描述数据的基本特征。常见的描述性统计量包括均值、中位数、众数、标准差、方差、四分位数等。这些统计量可以帮助我们了解数据的集中趋势、离散程度和分布特征。\n\n对于非计算机专业学生来说，掌握基本的描述性统计分析方法可以帮助我们初步了解数据的特征和规律。在Python中，我们可以使用NumPy和Pandas等库来计算各种描述性统计量。', null, '{}', '0', '2026-01-05 09:01:21.774841', '2026-01-05 09:01:21.774841', 4);
INSERT INTO books_jupytercell VALUES ('17', 'markdown', '## 2.2 相关性分析与回归分析\n\n相关性分析是研究两个或多个变量之间关系的统计方法。常见的相关性分析方法包括皮尔逊相关系数、斯皮尔曼等级相关系数等。这些方法可以帮助我们了解变量之间的相关程度和方向。\n\n回归分析是一种用于研究变量之间因果关系的统计方法，它通过建立回归模型来预测或解释变量之间的关系。常见的回归分析方法包括线性回归、多元线性回归、逻辑回归等。', null, '{}', '1', '2026-01-05 09:01:21.781592', '2026-01-05 09:01:21.781592', 5);
INSERT INTO books_jupytercell VALUES ('18', 'code', '# 描述性统计分析示例\nimport pandas as pd\nimport numpy as np\ndef calculate_stats(data):\n    df = pd.DataFrame(data)\n    print(\'基本统计摘要:\')\n    print(df.describe())\n    print(\'\n偏度:\', df.skew())\n    print(\'峰度:\', df.kurtosis())', null, '{}', '2', '2026-01-05 09:01:21.787563', '2026-01-05 09:01:21.787563', 5);
INSERT INTO books_jupytercell VALUES ('19', 'code', '# 相关性分析示例\nimport pandas as pd\ndef correlation_analysis(df):\n    corr_matrix = df.corr()\n    print(\'相关性矩阵:\')\n    print(corr_matrix)\n    return corr_matrix', null, '{}', '3', '2026-01-05 09:01:21.793781', '2026-01-05 09:01:21.793781', 5);
INSERT INTO books_jupytercell VALUES ('20', 'markdown', '## 2.1 机器学习的基本概念\n\n机器学习是人工智能的一个重要分支，它是一门研究如何使计算机系统通过经验自动改进的学科。机器学习的核心思想是让计算机从数据中学习规律，而不需要显式地编程指定规则。对于非计算机专业学生来说，了解机器学习的基本概念有助于我们理解人工智能技术的工作原理。\n\n机器学习的主要类型包括监督学习、无监督学习和强化学习等。监督学习是从标记数据中学习的方法，常见的任务包括分类和回归；无监督学习是从未标记数据中学习的方法，常见的任务包括聚类和降维；强化学习是通过与环境交互并接收奖惩信号来学习的方法，适用于决策和控制类任务。', null, '{}', '0', '2026-01-05 09:01:21.774841', '2026-01-05 09:01:21.774841', 5);
INSERT INTO books_jupytercell VALUES ('21', 'markdown', '## 2.2 机器学习算法简介\n\n线性回归是最基本的机器学习算法之一，它用于建模自变量和因变量之间的线性关系。线性回归假设自变量和因变量之间存在线性关系，通过最小化预测值和实际值之间的误差来学习模型参数。线性回归在房价预测、销售预测等问题中有着广泛的应用。\n\n决策树是一种基于树结构的分类和回归算法，它通过对特征进行递归分割来构建决策树。决策树具有直观、易于理解的特点，在医疗诊断、风险评估等领域有着广泛的应用。', null, '{}', '1', '2026-01-05 09:01:21.782600', '2026-01-05 09:01:21.782600', 6);
INSERT INTO books_jupytercell VALUES ('22', 'code', '# 简单线性回归示例\nimport numpy as np\ndef simple_linear_regression(x, y):\n    x_mean = np.mean(x)\n    y_mean = np.mean(y)\n    numerator = np.sum((x - x_mean) * (y - y_mean))\n    denominator = np.sum((x - x_mean) ** 2)\n    slope = numerator / denominator\n    intercept = y_mean - slope * x_mean\n    return slope, intercept', null, '{}', '2', '2026-01-05 09:01:21.789127', '2026-01-05 09:01:21.789127', 6);
INSERT INTO books_jupytercell VALUES ('23', 'code', '# K-means聚类简单示例\nimport numpy as np\ndef kmeans_sample():\n    print(\'K-means聚类是一种无监督学习算法，用于将数据分成多个簇。\')\n    print(\'算法步骤：\')\n    print(\'1. 随机选择K个聚类中心\')\n    print(\'2. 将每个数据点分配到最近的聚类中心\')\n    print(\'3. 更新聚类中心为每个簇的均值\')\n    print(\'4. 重复步骤2和3直到收敛\')', null, '{}', '3', '2026-01-05 09:01:21.793781', '2026-01-05 09:01:21.793781', 6);
INSERT INTO books_jupytercell VALUES ('24', 'markdown', '## 3.1 Word文档处理\n\nMicrosoft Word是最常用的文字处理软件，广泛应用于文档创建、编辑和排版等工作。对于非计算机专业学生来说，掌握Word的基本操作是学习和工作的必备技能。\n\nWord的主要功能包括文本输入与编辑、格式设置、段落设置、页面设置、表格制作、图片插入等。在学术写作中，我们经常需要使用Word来撰写论文、报告等文档。熟练掌握Word的样式、目录生成、引用和参考文献等功能可以大大提高学术写作的效率和质量。', null, '{}', '0', '2026-01-05 09:01:21.776405', '2026-01-05 09:01:21.776405', 6);
INSERT INTO books_jupytercell VALUES ('25', 'markdown', '## 3.2 Excel电子表格应用\n\nMicrosoft Excel是一款功能强大的电子表格软件，主要用于数据处理、数据分析和图表绘制等。对于非计算机专业学生来说，掌握Excel的基本操作和常用函数可以帮助我们更高效地处理和分析数据。\n\nExcel的主要功能包括数据输入和编辑、格式设置、公式和函数使用、数据分析工具、图表创建等。常用的函数包括求和函数SUM、平均值函数AVERAGE、计数函数COUNT、条件函数IF、查找函数VLOOKUP等。学会使用这些函数可以大大简化数据计算和分析的工作。', null, '{}', '1', '2026-01-05 09:01:21.782600', '2026-01-05 09:01:21.782600', 7);
INSERT INTO books_jupytercell VALUES ('26', 'code', '# Excel数据处理示例\nimport pandas as pd\ndef create_sample_data():\n    data = {\n        \'姓名\': [\'张三\', \'李四\', \'王五\', \'赵六\'],\n        \'语文\': [85, 92, 78, 90],\n        \'数学\': [90, 85, 95, 88],\n        \'英语\': [88, 90, 82, 95]\n    }\n    return pd.DataFrame(data)', null, '{}', '2', '2026-01-05 09:01:21.789127', '2026-01-05 09:01:21.789127', 7);
INSERT INTO books_jupytercell VALUES ('27', 'code', '# 简单的文本处理函数\ndef format_text(text, operation):\n    if operation == \'uppercase\':\n        return text.upper()\n    elif operation == \'lowercase\':\n        return text.lower()\n    elif operation == \'titlecase\':\n        return text.title()\n    else:\n        return text', null, '{}', '3', '2026-01-05 09:01:21.793781', '2026-01-05 09:01:21.793781', 7);
INSERT INTO books_jupytercell VALUES ('28', 'markdown', '## 3.1 数据可视化概述\n\n数据可视化是指将数据以图形或图像的形式呈现出来的技术。它可以帮助我们直观地理解数据的特征、趋势和关系，发现数据中隐藏的模式和规律。对于非计算机专业学生来说，掌握基本的数据可视化技能可以帮助我们更有效地展示和传达数据分析的结果。\n\n数据可视化的主要类型包括条形图、饼图、折线图、散点图、直方图、箱线图等。不同类型的图表适用于不同的数据类型和分析目的。', null, '{}', '0', '2026-01-05 09:01:21.776405', '2026-01-05 09:01:21.776405', 7);
INSERT INTO books_jupytercell VALUES ('29', 'markdown', '## 3.2 常用图表类型及应用\n\n条形图是最常见的数据可视化图表之一，它用矩形条的长度来表示数据的大小。条形图可以水平或垂直绘制，适用于比较不同类别的数据。在实际应用中，条形图常用于展示不同产品的销售额、不同地区的人口数量等比较数据。\n\n饼图用圆形和扇形来展示数据，其中圆形代表整体，扇形代表部分。饼图适用于展示部分与整体的关系，例如不同产品销售额占总销售额的比例、不同专业学生人数占总人数的比例等。', null, '{}', '1', '2026-01-05 09:01:21.782600', '2026-01-05 09:01:21.782600', 8);
INSERT INTO books_jupytercell VALUES ('30', 'code', '# 基本图表绘制示例\nimport matplotlib.pyplot as plt\ndef plot_bar_chart(labels, values):\n    plt.figure(figsize=(10, 6))\n    plt.bar(labels, values, color=\'skyblue\')\n    plt.title(\'条形图示例\')\n    plt.xlabel(\'类别\')\n    plt.ylabel(\'数值\')\n    plt.grid(axis=\'y\')', null, '{}', '2', '2026-01-05 09:01:21.790666', '2026-01-05 09:01:21.790666', 8);
INSERT INTO books_jupytercell VALUES ('31', 'code', '# 折线图绘制示例\nimport matplotlib.pyplot as plt\ndef plot_line_chart(x_values, y_values):\n    plt.figure(figsize=(10, 6))\n    plt.plot(x_values, y_values, marker=\'o\', color=\'green\')\n    plt.title(\'折线图示例\')\n    plt.xlabel(\'X轴\')\n    plt.ylabel(\'Y轴\')\n    plt.grid(True)', null, '{}', '3', '2026-01-05 09:01:21.795309', '2026-01-05 09:01:21.795309', 8);
INSERT INTO books_jupytercell VALUES ('32', 'markdown', '## 3.1 神经网络基础\n\n神经网络是深度学习的基础，它是由大量人工神经元相互连接而成的计算模型，灵感来源于人脑的神经元结构。对于非计算机专业学生来说，了解神经网络的基本结构和工作原理有助于我们理解深度学习的核心概念。\n\n神经网络的基本组成单元是人工神经元，它接收多个输入信号，通过权重加权后求和，再经过激活函数处理后输出结果。多个神经元按层次结构组织，形成输入层、隐藏层和输出层。输入层接收原始数据；隐藏层负责特征提取和处理；输出层产生最终的预测结果。', null, '{}', '0', '2026-01-05 09:01:21.777961', '2026-01-05 09:01:21.777961', 8);
INSERT INTO books_jupytercell VALUES ('33', 'markdown', '## 3.2 深度学习应用与实践\n\n深度学习技术已经广泛应用于各个领域，取得了令人瞩目的成果。在计算机视觉领域，深度学习在图像分类、目标检测、图像分割、人脸识别等任务中取得了突破性进展；在自然语言处理领域，深度学习在机器翻译、文本分类、情感分析、问答系统、文本生成等任务中表现出色；在语音识别领域，深度学习大幅提高了语音识别的准确率。', null, '{}', '1', '2026-01-05 09:01:21.784303', '2026-01-05 09:01:21.784303', 9);
INSERT INTO books_jupytercell VALUES ('34', 'code', '# 神经网络基本结构示例\ndef neural_network_structure():\n    print(\'神经网络基本结构示例：\')\n    print(\'输入层 -> 隐藏层 -> 输出层\')\n    print(\'激活函数：ReLU, Sigmoid, Tanh等\')\n    print(\'损失函数：MSE, Cross-Entropy等\')\n    print(\'优化算法：SGD, Adam, RMSprop等\')', null, '{}', '2', '2026-01-05 09:01:21.790666', '2026-01-05 09:01:21.790666', 9);
INSERT INTO books_jupytercell VALUES ('35', 'code', '# 深度学习应用领域\ndef deep_learning_applications():\n    applications = {\n        \'计算机视觉\': [\'图像分类\', \'目标检测\', \'人脸识别\', \'图像生成\'],\n        \'自然语言处理\': [\'机器翻译\', \'文本分类\', \'问答系统\', \'文本生成\'],\n        \'语音识别\': [\'语音转文字\', \'语音合成\', \'声纹识别\'],\n        \'推荐系统\': [\'商品推荐\', \'内容推荐\', \'个性化服务\']\n    }\n    return applications', null, '{}', '3', '2026-01-05 09:01:21.795309', '2026-01-05 09:01:21.795309', 9);
...
-- ----------------------------
INSERT INTO books_jupyternotebook VALUES ('1', '4', '4', '{\"kernelspec\": {\"name\": \"python\", \"language\": \"python\", \"display_name\": \"Python\"}, \"language_info\": {\"name\": \"python\", \"version\": \"3.9.0\"}}', '2026-01-05 09:01:21.760566', '2026-01-05 09:01:21.760566', 1);
...
INSERT INTO books_jupyternotebook VALUES ('3', '4', '4', '{\"kernelspec\": {\"name\": \"python\", \"language\": \"python\", \"display_name\": \"Python\"}, \"language_info\": {\"name\": \"python\", \"version\": \"3.9.0\"}}', '2026-01-05 09:01:21.763715', '2026-01-05 09:01:21.763715', 3);
INSERT INTO books_jupyternotebook VALUES ('4', '4', '4', '{\"kernelspec\": {\"name\": \"python\", \"language\": \"python\", \"display_name\": \"Python\"}, \"language_info\": {\"name\": \"python\", \"version\": \"3.9.0\"}}', '2026-01-05 09:01:21.765253', '2026-01-05 09:01:21.765253', 4);
...
INSERT INTO books_jupyternotebook VALUES ('6', '4', '4', '{\"kernelspec\": {\"name\": \"python\", \"language\": \"python\", \"display_name\": \"Python\"}, \"language_info\": {\"name\": \"python\", \"version\": \"3.9.0\"}}', '2026-01-05 09:01:21.766800', '2026-01-05 09:01:21.766800', 6);
...
INSERT INTO books_jupyternotebook VALUES ('9', '4', '4', '{\"kernelspec\": {\"name\": \"python\", \"language\": \"python\", \"display_name\": \"Python\"}, \"language_info\": {\"name\": \"python\", \"version\": \"3.9.0\"}}', '2026-01-05 09:01:21.770114', '2026-01-05 09:01:21.770114', 9);
...
-- ----------------------------
INSERT INTO toolkit_toolparameter VALUES ('1', 'folderPath', '文件夹路径', 'text', '例如: C:\\Users\\Documents\\Files', '', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('2', 'namingPattern', '命名模式', 'text', '例如: File_{index}.txt', 'File_{index}', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('3', 'fileType', '文件类型筛选', 'text', '例如: .txt,.pdf', '', '0', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('4', 'folderPath', '文件夹路径', 'text', '例如: C:\\Users\\Documents\\ExcelFiles', '', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('5', 'outputFileName', '输出文件名', 'text', '例如: merged_data.xlsx', 'merged_data.xlsx', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('6', 'includeHeaders', '包含表头', 'boolean', '', 'True', '0', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('7', 'filePath', '文件路径', 'text', '例如: C:\\Users\\Documents\\data.xlsx', '', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('8', 'sheetName', '工作表名称', 'text', '例如: Sheet1', '', '0', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('9', 'analysisColumn', '分析列', 'text', '例如: sales', '', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('10', 'folderPath', '文件夹路径', 'text', '例如: C:\\Users\\Documents\\Images', '', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('11', 'quality', '压缩质量', 'number', '', '80', '0', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('12', 'maxWidth', '最大宽度', 'number', '', '1920', '0', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('13', 'filePath', '文件路径', 'text', '例如: C:\\Users\\Documents\\sample.pdf', '', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('14', 'outputFormat', '输出格式', 'select', '', 'txt', '0', '[\"txt\", \"json\", \"markdown\"]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('15', 'jsonContent', 'JSON内容', 'textarea', '例如: {\"name\":\"value\"}', '', '1', '[]', '0', 1);
INSERT INTO toolkit_toolparameter VALUES ('16', 'indentSize', '缩进大小', 'number', '', '2', '0', '[]', '0', 1);
